...
function x_shortcode_card( $atts ) {
  ...
  $front_title          = ( $front_title          != ''     ) ? $front_title : 'Front Title';
  $front_text           = ( $front_text           != ''     ) ? $front_text : 'This is where the text for the front of your card should go. It\'s best to keep it short and sweet.';
  $back_style           = ( $back_style           != ''     ) ? $back_style : 'border: 1px solid #ddd; color: #272727; background-color: #fafafa;';
  $back_title           = ( $back_title           != ''     ) ? $back_title : 'Back Title';
  $back_text            = ( $back_text            != ''     ) ? $back_text : 'This is where the text for the back of your card should go.';
