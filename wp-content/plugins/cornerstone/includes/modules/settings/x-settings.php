...
class CS_Settings_X_Settings extends Cornerstone_Setting_Section_Base {
  ...
  public function handler( $atts ) {
    ...
    if ( $post->post_type == 'post') {
      $this->postHandler( $atts );
    } elseif ( $post->post_type == 'page') {
      $this->pageHandler( $atts );
    } elseif ( $post->post_type == 'x-portfolio') {
      $this->portfolioHandler( $atts );
    }

  }

  public function postHandler( $atts ) {
    ...
    update_post_meta( $post->ID, '_x_entry_alternate_index_title', $alternate_index_title );
  ...
  public function portfolioHandler( $atts ) {
