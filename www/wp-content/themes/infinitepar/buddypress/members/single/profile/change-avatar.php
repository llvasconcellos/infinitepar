...
<?php if ( !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
	...
	<form action="" method="post" id="avatar-upload-form" class="standard-form x-avatar-upload-form cf" enctype="multipart/form-data">
		...
		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<?php if ( bp_get_user_has_avatar() ) : ?>
				...
				<p>
					<?php _e( "If you'd like to delete your current avatar but not upload a new one, please use the following link:", '__x__' ); ?>
					<a href="<?php bp_avatar_delete_link(); ?>" title="<?php esc_attr_e( 'Delete Avatar', 'buddypress' ); ?>"><?php _e( 'Delete My Avatar', 'buddypress' ); ?></a>
				</p>
